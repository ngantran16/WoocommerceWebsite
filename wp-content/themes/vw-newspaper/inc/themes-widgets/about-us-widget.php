...
class VW_Newspaper_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'VW_Newspaper_About_Widget',
			__('VW About us', 'vw-newspaper'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'vw-newspaper' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','vw-newspaper'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','vw-newspaper'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','vw-newspaper'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','vw-newspaper'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','vw-newspaper'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','vw-newspaper'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function vw_newspaper_about_custom_load_widget() {
	register_widget( 'VW_Newspaper_About_Widget' );
}
add_action( 'widgets_init', 'vw_newspaper_about_custom_load_widget' );