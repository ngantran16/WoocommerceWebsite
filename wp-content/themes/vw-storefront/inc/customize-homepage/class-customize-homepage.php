...
if ( ! class_exists( 'VW_Storefront_Content_Creation' ) ) :

	/**
	 * VW_Storefront_Content_Creation class.
	 */
	class VW_Storefront_Content_Creation extends WP_Customize_Control {
		 ...
		 */
		public $type = 'vw-storefront-content-creation';
		...
		/**
		 * VW_Storefront_Content_Creation constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'VW_Storefront_Content_Creation' );
