...
/*---------------------------First highlight color-------------------*/
	...
	$vw_storefront_resp_metabox = get_theme_mod( 'vw_storefront_metabox_hide_show',true);
    if($vw_storefront_resp_metabox == true){
    	$vw_storefront_custom_css .='@media screen and (max-width:575px) {';
		$vw_storefront_custom_css .='.post-info{';
			$vw_storefront_custom_css .='display:block;';
		$vw_storefront_custom_css .='} }';
	}else if($vw_storefront_resp_metabox == false){
		$vw_storefront_custom_css .='@media screen and (max-width:575px) {';
		$vw_storefront_custom_css .='.post-info{';
			$vw_storefront_custom_css .='display:none;';
		$vw_storefront_custom_css .='} }';
	...
	$vw_storefront_resp_scroll_top = get_theme_mod( 'vw_storefront_resp_scroll_top_hide_show',false);
